...
using MVC_CarInsurance_CodeFirst.Controllers;
...
namespace MVC_CarInsurance_CodeFirst.DAL
{
    public class InsuranceInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<InsuranceContext>
    {
        ...
        {
            //defines a list of Applicant objects to initialize the database with
            ...
            {
                applicants[i].Quote = applicants[i].CalculateQuote(applicants[i]);
            }
